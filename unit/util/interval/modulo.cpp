...
SCENARIO("modulo interval domain", "[core][analyses][interval][modulo]")
{
  GIVEN("Two simple signed intervals")
  {
    ...
    WHEN("Positive RHS")
    {
      ...
      {
        REQUIRE(
          constant_interval_exprt::modulo(constant_interval_exprt(CEV(10), CEV(20))
        ...
        REQUIRE(
          ...
          constant_interval_exprt::top(signedbv_typet(32)));
        REQUIRE(
          constant_interval_exprt::modulo(constant_interval_exprt(CEV(-20), CEV(-10))
            , constant_interval_exprt(CEV(0), CEV(5))) ==
          constant_interval_exprt::top(signedbv_typet(32)));
        ...
        REQUIRE(
          constant_interval_exprt::modulo(constant_interval_exprt(CEV(30), CEV(50))
            , constant_interval_exprt(CEV(2), CEV(2))) ==
          constant_interval_exprt(CEV(0), CEV(1)));

        // Problems
        REQUIRE(
          constant_interval_exprt::modulo(constant_interval_exprt(CEV(30), max_exprt(signedbv_typet(32)))
            , constant_interval_exprt(CEV(2), CEV(2))) ==
          constant_interval_exprt(CEV(0), CEV(1)));
      }
    }
